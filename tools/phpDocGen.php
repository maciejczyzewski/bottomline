...
TEMPLATE;
    ...
    $wrapperSource = strtr($wrapperTemplate, [
        '{phpDoc}' => writeDocBlock($docBlock),
    ]);

    $filePath = dirname(__DIR__) . '/src/__/sequences/BottomlineWrapperBase.php';
    file_put_contents($filePath, $wrapperSource . "\n");
}
